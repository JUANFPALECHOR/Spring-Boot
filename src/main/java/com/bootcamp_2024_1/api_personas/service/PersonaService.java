...
import com.bootcamp_2024_1.api_personas.error.ErrorPersonaEdad;
...
public class PersonaService {
    ...
    public PersonaDto crearPersona(PersonaDto persona) {
        if (persona.getEdad() < MAYOR_EDAD || persona.getEdad() > 99) {
            throw new ErrorPersonaEdad("El rango esta entre 18 y 99");
        }
        PersonaEntity personaEntity = this.personaRepository.save(
                personaMapper.personaDtoPersonaEntity(persona)
        );
